/*Type definitions for SurveyJS PDF library v1.7.19
...
import { ItemValue, QuestionCheckboxBase } from 'survey-core';
...
import { PanelModel, PageModel } from 'survey-core';
...
export declare class SurveyHelper {
    ...
    static readonly VALUE_READONLY_FONT_SCALE: number;
...
export declare class TextBoldBrick extends TextBrick {
    constructor(question: IQuestion, controller: DocController, rect: IRect, text: string, fontSize?: number);
    renderInteractive(): Promise<void>;
}
