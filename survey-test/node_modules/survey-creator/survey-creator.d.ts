/*Type definitions for SurveyJS Creator JavaScript library v1.7.19
...
export declare class SurveyNestedPropertyEditorItem {
    ...
    constructor(obj: any, getColumns: () => Array<SurveyNestedPropertyEditorColumn>, options: ISurveyObjectEditorOptions, getItemClassName?: (item: any) => string, canDeleteItem?: boolean);
...
export declare class SurveyCreator implements ISurveyObjectEditorOptions {
        ...
        /**
            ...
            */
        onCollectionItemDeleting: Survey.Event<(sender: SurveyCreator, options: any) => any, any>;
        /**
...
export declare class PropertyEditorViewModel {
    ...
    afterRender: any;
    constructor(showDisplayNameOnTop: boolean, displayName: string, contentTemplateName: string, model: SurveyPropertyEditorBase, afterRender: any);
}
...
export declare class PropertyEditorStringViewModel {
    ...
    onKeydown: any;
    afterRender: () => void;
    constructor(koValue: any, readOnly: boolean, koInputType: any, defaultValue: any, koMaxLength: any, displayName: string, onKeydown: any, afterRender: () => void);
}
...
export declare class PropertyEditorOneSelectedViewModel {
    ...
    readonly originalValue: any;
    readonly selectedObjectEditor: ko.Observable<SurveyElementEditorContentModel>;
...
export declare class PropertyEditorNestedItemsViewModel {
    ...
    addItemText: any;
    afterRender: any;
    constructor(koIsList: any, getLocString: any, koShowHeader: any, columns: SurveyNestedPropertyEditorColumn[], sortableOptions: any, model: SurveyNestedPropertyEditor, koAllowAddRemoveItems: ko.Observable<boolean>, readOnly: any, onAddClick: any, onClearClick: any, koAllowRemoveAllItems: ko.Observable<boolean>, addItemText: any, afterRender: any);
    readonly originalValue: any;
}
...
export declare class PropertyEditorNestedItemViewModel {
    ...
    readonly cells: SurveyNestedPropertyEditorEditorCell[];
